...
function main() {
  ...
  $.getScript("https://cdnjs.cloudflare.com/ajax/libs/dompurify/2.2.6/purify.min.js", function () {
    ...
    function setUserResponse(val) {
      ...
      scrollToBottomOfResults(); // $(".chatbot-bot-msg").last().nextAll(".chatbot-bot-msg:first").focus();
      // $("#typing").focus();
      // .last()
    ...
    function addSuggestion(textToAdd, type) {
      setTimeout(function () {
        ...
        for (var i = 0; i < suggLength; i++) {
          ...
          markup += " data-payload='" + suggestions[i].payload + "'>" + suggestions[i].title + "</div><div/>"; // $(markup).appendTo("." + type);
        }
