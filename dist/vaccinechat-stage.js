...
function main() {
  ...
  $.getScript("https://cdnjs.cloudflare.com/ajax/libs/dompurify/2.2.6/purify.min.js", function () {
    ...
    var API_END_POINT = "https://chatbot.stage.neurosoph.io:15005/webhooks/rest/webhook";
    ...
    if (isWebSpeechSupported()) {
      ...
      try {
        ...
        recognition.addEventListener("start", function () {
          micOn = true;
          toggleMic();
          $("#tooltip-voice-on").removeClass("chatbot-hide-elem"); // $("#chatbot-mic-btn-on").focus();
        });
        ...
        recognition.addEventListener("end", function () {
          ...
          sendMessage();
          micOn = false;
          $("#tooltip-voice-on").addClass("chatbot-hide-elem"); // $("#chatbot-mic-btn-off").focus();
        });
    ...
    function setUserResponse(val) {
      ...
      noUserInput = false;
      var botResponse = "<div class=\"chatbot-bot-msg\" role=\"alert\" tabindex=0 aria-label=\"waiting for chatbot response\" id=\"typing\" style=\"font-size:".concat(fontSize, "px;border:0px;\">") + "<div id=\"chatbot-loading-msg\">\n                        <span class=\"chatbot-loading-dot\"></span>\n                        <span class=\"chatbot-loading-dot\"></span>\n                        <span class=\"chatbot-loading-dot\"></span>\n                        </div>" + '</div><div class="chatbot-clearfix"></div>';
      addBotResponse(botResponse, false);
      scrollToBottomOfResults();
      var ele = $(".chatbot-user-msg").last().nextAll(".chatbot-bot-msg:first"); // ele.focus();
    }
    ...
    }); // $(".chatbot-shortcut-list span").keydown(function (e) {
    //   if (e.keyCode == 27) {
    //     handleSettings();
    //     e.stopPropagation();
    //     setTimeout(() => {
    ...
    $(window).focus(function (e) {
      ...
      if (chatbotCanvas.length > 0 && localStorage.getItem(BOT_USER_HISTORY) == null) {
        sessionStarted = false;
        $("#chatbot-msgs").empty(); //clearLocalStorage();
